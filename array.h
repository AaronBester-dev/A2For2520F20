...
void readItem(struct Performance * performance, struct Array * array, unsigned int indext, void * dest);
...
void prependItem(struct Performance * performance, sturct Array * array, void * src);
